    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <p class="lead">Seamlessly actualize client-based users after out-of-the-box value. Globally
                    embrace strategic data through frictionless expertise.</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-7 col-md-12">
                <p>Phosfluorescently disintermediate revolutionary paradigms before enabled interfaces.
                    Dynamically transition skills vis-a-vis virtual customer service via impactful partnerships
                    with technically sound paradigms with cutting-edge initiatives. </p>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-12">
                <a href="career-single.html"
                    ...
                    <ul class="job-info-list list-inline list-unstyled text-muted">
                        ...
                        <li class="list-inline-item"><span class="fas fa-location-pin me-1"></span> London, UK
                        </li>
            ...
            <div class="col-lg-6 col-md-12">
                <a href="career-single.html"
                    ...
                    <ul class="job-info-list list-inline list-unstyled text-muted">
                        ...
                        <li class="list-inline-item"><span class="fas fa-location-pin me-1"></span> California
                        </li>
            ...
            <div class="col-lg-6 col-md-12">
                <a href="career-single.html"
                    ...
                    <ul class="job-info-list list-inline list-unstyled text-muted">
                        ...
                        <li class="list-inline-item"><span class="fas fa-location-pin me-1"></span> United
                            State
                            US</li>
                        <li class="list-inline-item"><span class="fas fa-wallet me-1"></span> $55k - $62k</li>
                    </ul>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-12">
                <div class="section-heading text-center">
                    ...
                    <p>Revolutionary paradigms before enabled interfaces dynamically transition technically
            ...
            <div class="col-md-6 col-lg-6">
                <div class="single-feature d-flex mt-0 p-5 bg-white rounded-custom">
                    ...
                    <div class="ms-4 mt-2">
                        ...
                        <p class="mb-0">Credibly syndicate enterprise total linkage whereas cost effective
                            innovate state of the art data without multifunctional. </p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6">
